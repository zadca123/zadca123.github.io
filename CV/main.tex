...
\begin{minipage}[t]{0.3\textwidth} % 27.5% of the page width for the second row of icons
    ...
    \icon{StackOverflow}{12}{\href{https://stackoverflow.com/users/17855207/zadca123}{/users/17855207/zadca123}}\\
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth} % 40% of the page width for the introduction text
    ...
    Student \textbf{Uniwersytetu Warmińsko-Mazurskiego} na \textbf{Wydziale Matematyki i Informatyki}, kierunek: \textbf{Inżynieria Systemów Informatycznych}. Pasjonat technologii, prywatności w sieci.\\ % Dummy text
\end{minipage}
...
\begin{center}
    \bubbles{4/Emacs, 5/vim, 4/git, 2/Office, 2/Gimp, 4/Regex, 3/MySQL}
\end{center}
